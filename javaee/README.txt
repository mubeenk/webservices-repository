...
a persistence unit "javaeePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javaee\pom.xml":
...
artifact ("javaee.war") is already built. You can build
