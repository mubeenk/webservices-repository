...
a persistence unit "javaee-soapPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "javaee-soap\pom.xml":
...
artifact ("javaee-soap.war") is already built. You can build
