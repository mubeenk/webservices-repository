...
a persistence unit "jee-jax-wsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jee-jax-ws\pom.xml":
...
artifact ("jee-jax-ws.war") is already built. You can build
